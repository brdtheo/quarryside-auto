...
export default function WheelListFilterAside({
  ...
  const wheelListFilterSections: ListFilterAsideSectionProps[] = useMemo(
    () => [
      {
        ...
        options: [
          {
            ...
            value: "true",
            isChecked: (searchParams?.delivery_available ?? "").includes(
              "true",
            ),
        ...
        options: [
          {
            ...
            value: "true",
            isChecked: (searchParams?.free_on_site_pickup ?? "").includes(
              "true",
            ),
            href: getUpdatedURLFromSearchParam(
              "free_on_site_pickup",
