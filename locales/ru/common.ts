export default {
  common: {
    ...
    deprecatedNoticeBadge: "0.34 данных",
    deprecatedNotice:
      "Этот веб-сайт больше не поддерживается, так как данные на нем основаны на версии 0.34",
    notFoundTitle: "ddd",
    notFoundDescription:
    ...
    emptySearchDescription:
      "Нет результатов, соответствующих вашему поиску. Попробуйте использовать другие фильтры.",
    ...
    sortResults: {
      ...
      option: {
        priceAsc: "Цена - от низкой до высокой",
        priceDesc: "Цена - от высокой до низкой",
        mileageAsc: "Пробег - от низкого до высокого",
        mileageDesc: "Пробег - от большого до малого",
        yearAsc: "Год - самый старый первый",
        yearDesc: "Год - последний первый",
      },
    },
    header: {
      myCart: "моя тележка",
    ...
    subHeader: {
      usedVehicles: "Подержанные автомобили",
      rimsTires: "Обода и шины",
      careers: "Карьера",
