...
export default function WheelCard({ wheel }: WheelCardProps) {
  ...
  return (
    <article className="@container/wheelcard w-full @md/wheelcard:w-52 h-full">
      <Link
        href={href}
        className="border border-grey rounded flex w-full h-full @md/wheelcard:w-52 bg-white dark:bg-blacksecondary dark:border-blacksecondary bg-clip-content overflow-hidden"
      >
        <div className="w-full h-full flex flex-col gap-2">
          ...
          <div className="flex flex-col flex-1 justify-between px-4 pt-2 pb-4">
