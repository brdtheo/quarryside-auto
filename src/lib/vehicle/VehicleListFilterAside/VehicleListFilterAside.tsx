  ...
  const vehicleListFilterSections: ListFilterAsideSectionProps[] = [
    {
      ...
      options: Object.values(VehicleCondition).map((condition) => ({
        ...
        href: getQueryParamLink("condition", String(condition), true),
      })),
      isSearchable: false,
    ...
    },
    {
      ...
      options: Object.values(VehicleBodyStyle).map((bodyStyle) => ({
        ...
        href: getQueryParamLink("body_style", String(bodyStyle), true),
      })),
      isSearchable: true,
    ...
    },
    {
      ...
      options: Object.values(VehicleFuelType).map((fuelType) => ({
        ...
        href: getQueryParamLink("fuel_type", String(fuelType), true),
      })),
      isSearchable: false,
    ...
    },
    {
      ...
      options: Object.values(VehicleTransmission).map((transmission) => ({
        ...
        href: getQueryParamLink("transmission", String(transmission), true),
      })),
      isSearchable: true,
    ...
    },
    {
      ...
      options: Object.values(VehicleDrivetrain).map((drivetrain) => ({
        ...
        href: getQueryParamLink("drivetrain", String(drivetrain), true),
      })),
      isSearchable: true,
    ...
    },
    {
      ...
      options: Object.values(VehicleCountry).map((country) => ({
        ...
        href: getQueryParamLink("country", String(country), true),
      })),
      isSearchable: true,
